...
class GiveCoursesType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('idMatiere', ChoiceType::class, ["label"=>"Matière :", "choices"=>["Test"=>"Test", "php"=>"PHP"], "required"=>true])
            ->add('idPromo', ChoiceType::class, ["label"=>"Difficulté :", "choices"=>["B1"=>"B1", "WIS1"=>"WIS1"], "required"=>true])
        ;
    }
