...
{
    /**
     * @Route("/forum/boite/see", name="voir_boite")
     */
    public function seeQuestion()
    {
        ...
        return $this->render('boite/see.html.twig', ["questions_forums" => $questions_forums]);
    ...
    public function addQuestion(Request $request)
    {
        ...
        if ($questionForm->isSubmitted() && $questionForm->isValid()) {
            ...
            return $this-> redirectToRoute("voir_boite");
        }

        return $this-> render("boite/post.html.twig", ["questionForm"=> $questionForm->createView()]);
    }
}
