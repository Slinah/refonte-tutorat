...
{
    /**
     * @Route("/forum/reseaux/see", name="voir_reseaux")
     */
    public function seeQuestion()
    {
        ...
        return $this->render('reseaux/see.html.twig', ["questions_forums" => $questions_forums]);
...
//            $question->setMatiere($result);
            ...
            return $this-> redirectToRoute("voir_reseaux");
        }

        return $this-> render("reseaux/post.html.twig", ["questionForm"=> $questionForm->createView()]);
    }
}
